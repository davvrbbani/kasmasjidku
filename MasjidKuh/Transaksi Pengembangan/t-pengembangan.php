...
<main class="app-main">
  <div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h3 class="mb-0">Transaksi Pengembangan Masjid</h3>
        </div>
        <div class="col-sm-6">
              ...
              <div class="d-flex justify-content-end align-items-center mt-2">
                ...
                <div class="col-md-4">
                  <div class="d-grid gap-2 d-md-flex"> <button type="submit" class="btn btn-primary flex-fill">
                    ...
                    <a href="Transaksi Pengembangan/print_t-pengembangan.php?tgl_awal=<?= $tgl_awal ?>&tgl_akhir=<?= $tgl_akhir ?>" target="_blank" class="btn btn-secondary flex-fill">
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="text-center align-middle">
                      ...
                      <td>
                        <a href="?p=edit_tp&id=<?= $d['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                        <a href="?p=hps_tp&id=<?= $d['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus data ini?')">Hapus</a>
                      </td>
                  ...
                  ?>
                    <tr>
                      <td colspan="7" class="text-center text-muted fst-italic py-3">Belum ada riwayat Pengeluaran atau Pemasukan</td>
                    </tr>
                  <?php endif; ?>
                </tbody>
              </table>
